...
- implement the slice behavior end-to-end across: `tests/unit/router/application/test_correction_audit.py`, `_docs/_MCP_SERVER/README.md`, `_docs/_ROUTER/README.md`, `README.md`
...
- touch `tests/unit/router/application/test_correction_audit.py` with an explicit change note (or explicit no-change rationale)
- touch `_docs/_MCP_SERVER/README.md` with an explicit change note (or explicit no-change rationale)
- touch `_docs/_ROUTER/README.md` with an explicit change note (or explicit no-change rationale)
