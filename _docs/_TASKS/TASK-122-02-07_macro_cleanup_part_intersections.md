...
Add a bounded macro for resolving or reducing obvious part intersections in assembled creature-style models.
...
- the macro can reduce or resolve intersection issues with bounded correction rules rather than unconstrained cleanup
- the macro report states which intersections were targeted and which deterministic overlap/contact checks should run next
