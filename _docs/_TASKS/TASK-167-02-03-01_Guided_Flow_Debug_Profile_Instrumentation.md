...
| `server/adapters/mcp/session_capabilities_runtime_glue.py` | `mark_guided_spatial_state_stale(...)`, `mark_guided_spatial_state_stale_async(...)` | lines 483 and 531 | guided-flow rearm and persistence are applied here |
