...
- implement the slice behavior end-to-end across: `server/adapters/mcp/contracts/scene.py`, `server/domain/tools/scene.py`
...
- touch `server/domain/tools/scene.py` with an explicit change note (or explicit no-change rationale)
