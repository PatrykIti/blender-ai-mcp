...
- implement the slice behavior end-to-end across: `tests/unit/adapters/mcp/test_assistant_runner.py`, `tests/unit/router/application/`, `_docs/_MCP_SERVER/README.md`, `_docs/_ROUTER/RESPONSIBILITY_BOUNDARIES.md`
...
- touch `tests/unit/router/application/` with an explicit change note (or explicit no-change rationale)
