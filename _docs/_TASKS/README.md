...
|----|-------|----------|-------|
| [TASK-057](./TASK-057_Remove_Old_Pattern_Expansion_Path.md) | **Remove Old Pattern-Based Expansion Path** | 🟡 Medium | Dead code cleanup: remove `_expand_workflow()` and `expansion_engine.expand()` |
