...
Implementation status (2026-05-30, validated against the full Blender E2E suite). Every family has at least one shipped, tested, committed slice; the full `tests/unit` suite (3551) is green and the live-model E2E lane passes. Fully done (5 families, all subtasks complete): ✅ `TASK-174` (caption interleaving; a roster-format regression it introduced was caught by the live-model E2E lane and fixed, changelogs 368/377), ✅ `TASK-175`, ✅ `TASK-176` (changelogs 369–370), ✅ `TASK-178` (structured per-finding compare schema end-to-end, changelogs 372/373/379), ✅ `TASK-183` (capability-aware schema + curated payload + backend passthrough fix + silhouette calibration & IoU convergence, changelogs 374/380). In progress with a shipped core slice: 🚧 `TASK-177` (177-01 budget-aware view selection, changelog 371), 🚧 `TASK-179` (179-02 deterministic per-object mask IoU, changelog 376), 🚧 `TASK-180` (180-01 deterministic Set-of-Mark overlay + isolated-render orchestration, changelog 378), 🚧 `TASK-181` (181-03 relation-triplet prompt serialization, changelog 375), 🚧 `TASK-182` (182-01 stable defect-id substrate, changelog 373).
