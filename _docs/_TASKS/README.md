...
| [TASK-158](./TASK-158_Vision_And_Creature_Gate_Boundary_Doc_Alignment.md) | **Reference Understanding Follow-Up And Boundary Alignment** | 🔴 High | Two-scope follow-up after TASK-157: keep the existing Vision/creature docs alignment scope and add bounded reference-understanding plus default-off optional-perception implementation work that consumes, but does not widen, the TASK-157 gate/verifier substrate. |
---
...
|----|-------|----------|-----------------|
| [TASK-145](./TASK-145_Spatial_Repair_Planner_And_Sculpt_Handoff_Context.md) | **Spatial Repair Planner and Sculpt Handoff Context** | 🔴 High | 2026-04-30 |
