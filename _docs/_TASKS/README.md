...
Implementation status (2026-05-30/31 audit-fix branch; validation tracked by changelogs 389-394). **Fully done families in the `TASK-174` through `TASK-183` Vision Output Quality wave: `TASK-174`, `TASK-175`, `TASK-176`, `TASK-177`, `TASK-178`, `TASK-179`, `TASK-180`, `TASK-181`, `TASK-182`, and `TASK-183`.** `TASK-173` is also closed as the creature scope-convergence consumer follow-up. The audit-fix branch closes previously identified drift in field descriptions/read-order docs, packet-synthesis truncation accounting, top-level confidence clamping, optional grid transmission, live capture-side object-ID IoU sidecars, fixture-calibrated per-object IoU thresholds, default-off auxiliary depth/normal/object-ID transmission, default-off live Set-of-Mark overlay capture, stable mark IDs, reference-side mark provenance, mark-keyed correspondence/retry, registry-scoped compare, creature shape-convergence iterate holds, appendage-bounded optional grounding policy, runtime evidence surfacing, capability-aware schema/payload routing, provider usage reporting, lightweight silhouette consistency/convergence, and Critic/Verify defect tracking with provenance-ranked next actions.

Promoted child work completed on 2026-05-31:
...
- **graph/loop authority:** `TASK-181-01` (registry-as-compare-scope staged-compare rewrite), `TASK-182-01` (Critic/Verify defect/status round-trip on same packet recapture), `TASK-182-02` (deterministic-first provenance and channel consolidation)

Completed substrates and child slices nested under completed umbrellas: `TASK-173-01`, `TASK-173-02`, `TASK-173-03`, `TASK-173-04`, `TASK-177-01`, `TASK-177-02`, `TASK-177-03`, `TASK-179-01`, `TASK-179-02`, `TASK-179-03`, `TASK-180-01`, `TASK-180-02`, `TASK-180-03`, `TASK-180-04`, `TASK-181-01`, `TASK-181-02`, `TASK-181-03`, `TASK-181-04`, `TASK-182-01`, and `TASK-182-02`.
