...
- implement the slice behavior end-to-end across: `server/adapters/mcp/contracts/router.py`, `server/application/tool_handlers/router_handler.py`, `server/adapters/mcp/areas/router.py`, `server/adapters/mcp/router_helper.py`
