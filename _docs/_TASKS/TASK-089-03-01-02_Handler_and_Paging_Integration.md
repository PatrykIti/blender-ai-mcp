...
- implement the slice behavior end-to-end across: `server/application/tool_handlers/mesh_handler.py`, `server/adapters/mcp/areas/mesh.py`
...
- touch `server/adapters/mcp/areas/mesh.py` with an explicit change note (or explicit no-change rationale)
