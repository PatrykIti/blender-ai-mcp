...
**Repository Touchpoints:** `tests/e2e/vision/test_reference_guided_squirrel_quality_regression.py`, `tests/e2e/vision/test_reference_stage_truth_handoff.py`, `tests/e2e/vision/test_reference_understanding_runtime_surface.py`, `_docs/_PROMPTS/REFERENCE_GUIDED_CREATURE_BUILD.md`, `_docs/_PROMPTS/GUIDED_SESSION_START.md`, `_docs/_MCP_SERVER/README.md`, `_docs/_VISION/REFERENCE_UNDERSTANDING_ROADMAP.md`, `_docs/_VISION/README.md`, `_docs/_TASKS/README.md`, `_docs/_CHANGELOG/README.md`, `_docs/_CHANGELOG/*`
**Acceptance Criteria:**
...
assert iterate.reference_orchestrator_feedback.recommended_repairs
```
...
- `git diff --check`
- focused validation is owned by the child tasks above
- final closeout should also run the repo-standard proof bundle required by the
