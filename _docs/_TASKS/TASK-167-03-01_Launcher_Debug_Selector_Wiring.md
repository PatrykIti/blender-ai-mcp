...
**Repository Touchpoints:** `scripts/run_streamable_openrouter.sh`, `scripts/run_mcp_server.py`, `scripts/run_mcp_server.sh`, `scripts/RUN_MCP_SERVER.md`, `scripts/_RUN_DOCKER_MCP.md`, `tests/unit/scripts/test_script_tooling.py`
**Acceptance Criteria:**
...
| `scripts/_RUN_DOCKER_MCP.md` | Docker helper runbook | current Docker snippets | Docker-facing guidance must stay aligned with the same selector contract |
