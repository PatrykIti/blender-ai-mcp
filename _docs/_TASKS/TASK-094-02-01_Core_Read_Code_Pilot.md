...
- implement the slice behavior end-to-end across: `server/application/tool_handlers/scene_handler.py`, `server/application/tool_handlers/mesh_handler.py`, `server/application/tool_handlers/workflow_catalog_handler.py`
