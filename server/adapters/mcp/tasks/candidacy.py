...
TASK_CANDIDACY_MATRIX: tuple[TaskCandidacy, ...] = (
    ...
    TaskCandidacy(
        ...
        backend_kind="planned",
        adopted=False,
        rationale="Import/export rollout remains classified but is intentionally deferred until the first vertical slices are stable.",
    ),
    TaskCandidacy(
    ...
    TaskCandidacy(
        ...
        backend_kind="planned",
        adopted=False,
        rationale="Export paths stay classified for later adoption once background job semantics are proven on the initial slices.",
    ),
    TaskCandidacy(
