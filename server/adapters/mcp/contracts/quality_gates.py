    ...
    if profile == "creature":
        templates.extend(
            [
                ...
                DomainQualityGateTemplateContract(
                    domain_profile=profile,
                    gate_id="creature_tail_mass_required",
                    gate_type="required_part",
                    label="Tail mass is present",
                    target_kind="object_role",
                ...
                DomainQualityGateTemplateContract(
                    domain_profile=profile,
                    gate_id="creature_snout_mass_required",
                    gate_type="required_part",
                    label="Snout mass is present",
                    target_kind="object_role",
                    target_label="snout_mass",
                    required=True,
                    priority="high",
                ),
                DomainQualityGateTemplateContract(
                ...
                DomainQualityGateTemplateContract(
                    domain_profile=profile,
                    gate_id="creature_foreleg_pair_required",
                    gate_type="required_part",
                    label="Foreleg pair is present",
                    target_kind="object_role",
                    target_label="foreleg_pair",
                    required=True,
                    priority="high",
                ),
                DomainQualityGateTemplateContract(
                    domain_profile=profile,
                    gate_id="creature_hindleg_pair_required",
                    gate_type="required_part",
                    label="Hindleg pair is present",
                    target_kind="object_role",
                    target_label="hindleg_pair",
                    required=True,
                    priority="high",
                ),
            ]
        ...
        templates.extend(
            [
                DomainQualityGateTemplateContract(
                    domain_profile=profile,
                    gate_id="building_footprint_mass_required",
                    gate_type="required_part",
                    label="Footprint/base mass is present",
                    target_kind="object_role",
                    target_label="footprint_mass",
                    required=True,
                    priority="high",
                ),
                DomainQualityGateTemplateContract(
                ...
                DomainQualityGateTemplateContract(
                    domain_profile=profile,
                    gate_id="building_wall_shell_required",
                    gate_type="required_part",
                    label="Wall shell is present",
                    target_kind="object_role",
                    target_label="wall_shell",
                    required=True,
                    priority="high",
                ),
                DomainQualityGateTemplateContract(
                ...
                DomainQualityGateTemplateContract(
                    domain_profile=profile,
                    gate_id="building_roof_wall_seam",
                    gate_type="attachment_seam",
                    label="Roof is seated on the wall shell",
                    target_kind="object_pair",
                    target_label="roof_wall",
                    required=True,
                    priority="high",
                    allowed_correction_families=["spatial_context", "attachment_alignment", "inspect_validate"],
                ),
                DomainQualityGateTemplateContract(
                    domain_profile=profile,
                    gate_id="building_opening_grid_required",
                    gate_type="opening_or_cut",
                    label="Facade openings are cut into the wall shell",
                    target_kind="object_role",
                    target_label="facade_opening",
                    required=True,
                    priority="high",
                ...
                DomainQualityGateTemplateContract(
                    domain_profile=profile,
                    gate_id="building_facade_rhythm_profile",
                    gate_type="shape_profile",
                    label="Facade opening rhythm and floor bands match the reference",
                    target_kind="object_role",
                    target_label="opening_grid",
                    required=True,
                    priority="normal",
                ),
                DomainQualityGateTemplateContract(
                    domain_profile=profile,
                    gate_id="building_support_contact",
                    gate_type="support_contact",
                    label="Supports or posts carry the expected mass",
                    target_kind="object_role",
                    target_label="support_element",
                    required=False,
                    priority="normal",
                ),
            ]
