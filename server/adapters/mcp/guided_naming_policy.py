...
_ROLE_NAMING_SPECS: dict[str, dict[str, _RoleNamingSpec]] = {
    ...
    "building": {
        ...
        "main_volume": _RoleNamingSpec(
            ...
            strong_hints=("mainvolume", "volume", "tower", "core", "facade"),
        ),
        "wall_shell": _RoleNamingSpec(
            role="wall_shell",
            canonical_pattern="WallShell",
            suggested_names=("WallShell", "FacadeWallShell"),
            strong_hints=("wall", "wallshell", "shell", "facade", "building_shell"),
        ),
        "roof_mass": _RoleNamingSpec(
            role="roof_mass",
            canonical_pattern="Roof",
            suggested_names=("Roof", "RoofMass", "RoofRidge"),
            strong_hints=("roof", "gable", "top", "ridge", "roofline"),
        ),
        ...
        "opening_grid": _RoleNamingSpec(
            role="opening_grid",
            canonical_pattern="OpeningGrid",
            suggested_names=("OpeningGrid", "FacadeOpeningGrid"),
            strong_hints=("openinggrid", "windowgrid", "facadegrid", "baygrid", "rhythm", "bay", "floorband"),
        ),
        "support_element": _RoleNamingSpec(
            role="support_element",
            canonical_pattern="Support_A",
            suggested_names=("Support_A", "Support_B", "Column_A", "Post_A"),
            strong_hints=(
                "support",
                "buttress",
                "buttresses",
