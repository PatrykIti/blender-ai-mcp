...
VISION_OPENROUTER_MODEL="${VISION_OPENROUTER_MODEL:-x-ai/grok-4.20-multi-agent}"
...
VISION_OPENROUTER_REQUIRE_PARAMETERS="${VISION_OPENROUTER_REQUIRE_PARAMETERS:-true}"
