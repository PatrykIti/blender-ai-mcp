...
def test_refinement_step_limits_creature_handoff_to_bounded_profile_tools():
    """Low-poly refinement should not reopen primary-mass or finish-heavy tools by default."""
