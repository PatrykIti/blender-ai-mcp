...
class TestMeshSelectMega:
    ...
    def test_action_all_routes_to_select_all(self, mock_select_all):
    ...
    @patch("server.adapters.mcp.areas.mesh._mesh_select_all")
    def test_action_none_routes_to_select_all_deselect(self, mock_select_all):
    ...
    def test_action_linked_routes_to_select_linked(self, mock_select_linked):
    ...
    def test_action_more_routes_to_select_more(self, mock_select_more):
    ...
    def test_action_less_routes_to_select_less(self, mock_select_less):
    ...
    def test_action_boundary_routes_to_select_boundary(self, mock_select_boundary):
    ...
    @patch("server.adapters.mcp.areas.mesh._mesh_select_boundary")
    def test_action_boundary_with_vert_mode(self, mock_select_boundary):
